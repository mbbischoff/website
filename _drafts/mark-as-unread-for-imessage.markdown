...
For decades, email apps like Gmail, Outlook, and Apple Mail have all included a button to mark a message as “unread”. But why? Since the software knows the message has been read, why is it allowing the user to override that truth and rewrite history?
